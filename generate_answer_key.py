...
parser.add_argument("--mathWorksheet", type=str, default='./MathWorksheets/0001.png', help='the math worksheet file')
...
img_rgb = cv2.imread(args.mathWorksheet)
img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)

clean_output_img_rgb = cv2.imread(args.mathWorksheet)
